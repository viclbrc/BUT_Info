...
- [Version 1](https://github.com/viclbrc/BUT_Info/blob/main/sokoban/v1)
- [Version 2](https://github.com/viclbrc/BUT_Info/blob/main/sokoban/v2)

### [SAÉ 1.02 Comparaison d'approches algorithmiques (sokoban)](https://github.com/viclbrc/BUT_Info/tree/main/sokoban/sokoban_auto)

Automatisation du sokoban de la SAÉ 1.01 :

- Avec un fichier de niveau .sok et un fichier de déplacements .dep, le jeu doit s'effectuer tout seul et dire si la suite déplacements termine le niveau ou pas.

2 Versions différentes :
- [Version 1](https://github.com/viclbrc/BUT_Info/blob/main/sokoban/sokoban_auto/v1)
- [Version 2](https://github.com/viclbrc/BUT_Info/blob/main/sokoban/sokoban_auto/v2)
...
[Consignes](https://github.com/viclbrc/BUT_Info/tree/main/bdd)
